        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 text-center">
                ...
                <div class="d-flex gap-3 justify-content-center">
                    <a href="<?php echo e(url('/')); ?>" class="btn btn-orange btn-lg px-4">
                        <i class="fas fa-home me-2"></i> Kembali ke Beranda
                    </a>
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-orange btn-lg px-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u972015595/domains/lavenderblush-cod-866989.hostingersite.com/public_html/laravel_app/resources/views/errors/404.blade.php ENDPATH**/ ?>