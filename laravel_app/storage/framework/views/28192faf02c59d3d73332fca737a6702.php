...
<?php $__env->startSection('title', 'Sejarah - SMP Islam Parung'); ?>
    ...
    <div class="school-info-card">
        <div class="row g-0">
            ...
            <div class="col-md-8 p-4" style="background-color: #1b5e20;">
                <div class="pe-3">
                    <h2 class="text-white mb-4 fw-bold"><?php echo e($info->nama ?? 'Nama Sekolah'); ?></h2>

                    <ul class="list-unstyled text-white">
                        <li class="mb-3 d-flex align-items-start">
                            <i class="fas fa-map-marker-alt me-3 mt-1"></i>
                            <div>
                                <p class="mb-1"><?php echo e($info->alamat); ?></p>
                            </div>
                        </li>

                        <li class="mb-3 d-flex align-items-center">
                            <i class="fas fa-phone me-3"></i>
                            <p class="mb-0"><?php echo e($info->telepon); ?></p>
                        </li>

                        <li class="mb-3 d-flex align-items-center">
                            <i class="fas fa-mobile-alt me-3"></i>
                            <p class="mb-0"><?php echo e($info->hp ?? '-'); ?></p> 
                        </li>

                        <li class="d-flex align-items-center">
                            <i class="fas fa-envelope me-3"></i>
                            <p class="mb-0"><?php echo e($info->email ?? 'info@smpislamparung.sch.id'); ?></p> 
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-4 bg-white d-flex align-items-center justify-content-center p-4">
                <div class="text-center">
                    <img src="<?php echo e(asset('storage/' . $info->logo)); ?>"
                        alt="Logo <?php echo e($info->nama); ?>"
    ...
    <div class="history-details">
        <div class="detail-item bg-light-hover p-4 rounded-3 mb-3">
            <dl class="row">
                ...
                <dd class="col-sm-8"><?php echo e($sejarah?->tahun_berdiri ?? '-'); ?></dd>

                <dt class="col-sm-4"><i class="fas fa-school me-2 text-success"></i>Bentuk Sekolah</dt>
                <dd class="col-sm-8"><?php echo e($sejarah?->bentuk_sekolah ?? '-'); ?></dd>

                <dt class="col-sm-4"><i class="fas fa-star me-2 text-success"></i>Status Sekolah</dt>
                <dd class="col-sm-8"><?php echo e($sejarah?->status_sekolah ?? '-'); ?></dd>

                <dt class="col-sm-4"><i class="fas fa-file-alt me-2 text-success"></i>SK BAN Kab. Bogor</dt>
                <dd class="col-sm-8">
                    <?php echo e($sejarah?->sk_ban ?? '-'); ?><br>
                    <?php if($sejarah?->tgl_sk_ban): ?>
                        <small class="text-muted">
                            Tanggal <?php echo e(Carbon::parse($sejarah->tgl_sk_ban)->translatedFormat('d F Y')); ?>
                ...
                <dd class="col-sm-8"><?php echo e($sejarah?->waktu_penyelenggaraan ?? '-'); ?></dd>

                <dt class="col-sm-4"><i class="fas fa-file-signature me-2 text-success"></i>Dokumen Legal</dt>
                <dd class="col-sm-8">
                    <div>
                        SK Izin: <?php echo e($sejarah?->sk_izin ?? '-'); ?>

                        <?php if($sejarah?->tgl_sk_izin): ?>
                            (<?php echo e(Carbon::parse($sejarah->tgl_sk_izin)->translatedFormat('d F Y')); ?>)
                        <?php endif; ?>
                    </div>
                    <div>
                        Surat Pengukuhan: <?php echo e($sejarah?->surat_pengukuhan ?? '-'); ?>

                        <?php if($sejarah?->tgl_surat_pengukuhan): ?>
                            (<?php echo e(Carbon::parse($sejarah->tgl_surat_pengukuhan)->translatedFormat('d F Y')); ?>)
                        <?php endif; ?>
                    </div>
                </dd>
                ...
                <dd class="col-sm-8">
                    <div>NSS: <?php echo e($sejarah?->nss ?? '-'); ?></div>
                    <div>NDS: <?php echo e($sejarah?->nds ?? '-'); ?></div>
                    <div>NPSN: <?php echo e($sejarah?->npsn ?? '-'); ?></div>
                </dd>
            </dl>
        </div>
    </div>
    ...
    <div class="col-lg-5 d-flex flex-column">
        ...
        <div class="leadership-section mb-5">
            ...
            <div class="leadership-list" style="max-height: 400px; overflow-y: auto;">
                <?php $__empty_1 = true; $__currentLoopData = $kepalaSekolahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="leader-item bg-light-hover p-3 rounded-3 mb-2">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fw-semibold"><?php echo e($leader->nama); ?></h5>
                                <span class="badge bg-success"><?php echo e($leader->periode); ?></span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="asset-section mb-4">
            ...
            <div class="asset-list">
                <div class="asset-item bg-light-hover p-3 rounded-3 mb-2 d-flex justify-content-between">
                    ...
                    <span class="fw-semibold"><?php echo e($aset?->status_kepemilikan_tanah ?? '-'); ?></span>
                </div>
                <div class="asset-item bg-light-hover p-3 rounded-3 mb-2 d-flex justify-content-between">
                    <span>Total Luas Tanah</span>
                    <span class="fw-semibold"><?php echo e($aset?->luas_tanah ?? '-'); ?> m²</span>
                </div>
                <div class="asset-details row g-2">
                    <div class="col-6">
                        <div class="bg-light-hover p-3 rounded-3 h-100">
                            <small class="text-muted d-block">Bangunan</small>
                            <div class="fw-semibold"><?php echo e($aset?->luas_bangunan ?? '-'); ?> m²</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="bg-light-hover p-3 rounded-3 h-100">
                            <small class="text-muted d-block">Parkir</small>
                            <div class="fw-semibold"><?php echo e($aset?->luas_parkir ?? '-'); ?> m²</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="bg-light-hover p-3 rounded-3 h-100">
                            <small class="text-muted d-block">Lapangan</small>
                            <div class="fw-semibold"><?php echo e($aset?->luas_lapangan ?? '-'); ?> m²</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="bg-light-hover p-3 rounded-3 h-100">
                            <small class="text-muted d-block">Lainnya</small>
                            <div class="fw-semibold"><?php echo e($aset?->luas_lainnya ?? '-'); ?> m²</div>
                        </div>
                    </div>
                </div>
                <div class="asset-item bg-light-hover p-3 rounded-3 mt-2 d-flex justify-content-between align-items-center">
                    ...
                    <code class="text-success"><?php echo e($aset?->sertifikat_tanah ?? '-'); ?></code>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="asset-section mb-4">
            ...
            <div class="asset-list">
                <div class="asset-item bg-light-hover p-3 rounded-3 mb-2 d-flex justify-content-between">
                    <span>Status Kepemilikan</span>
                    <span class="fw-semibold"><?php echo e($aset?->status_kepemilikan_gedung ?? '-'); ?></span>
                </div>
                <div class="asset-item bg-light-hover p-3 rounded-3 d-flex justify-content-between">
                    <span>Total Luas Bangunan</span>
                    <span class="fw-semibold"><?php echo e($aset?->total_luas_gedung ?? '-'); ?> m²</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="container my-5">
    ...
    <div class="row g-5 align-items-center mb-5">
            ...
            <div class="pe-lg-5">
                ...
                <div class="mt-4">
                    ...
                    <div class="list-group">
                        <?php $__currentLoopData = $visimisi->indikator_visi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-group-item border-0 bg-transparent px-0">
                                <div class="d-flex align-items-start">
                                    <span class="badge bg-success text-white me-3"><?php echo e($i + 1); ?></span>
                                    <div class="flex-grow-1">
        ...
        <!-- Gambar Visi -->
        <div class="col-lg-6">
            <img src="<?php echo e(asset('storage/' . $visimisi->gambar_visi)); ?>"
                 alt="Gambar Visi"
    ...
    <div class="row g-5 align-items-center mt-5">
        <!-- Gambar Misi -->
        <div class="col-lg-6">
            <img src="<?php echo e(asset('storage/' . $visimisi->gambar_misi)); ?>"
                 alt="Gambar Misi"
                 class="img-fluid rounded-4 shadow-lg">
        </div>
        ...
        <div class="col-lg-6">
            <div class="ps-lg-5">
                ...
                <div class="list-group">
                    <?php $__currentLoopData = $visimisi->daftar_misi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-group-item border-0 bg-transparent px-0">
                            <div class="d-flex align-items-start">
                                <span class="badge bg-success text-white me-3"><?php echo e($i + 1); ?></span>
                                <div class="flex-grow-1">
...
<div class="container mb-5">
    ...
    <?php if($struktur?->gambar): ?>
        <div class="structure-container position-relative rounded-4 overflow-hidden shadow-lg"
            ...
            <img src="<?php echo e(Storage::url($struktur->gambar)); ?>"
    ...
    <div class="container">
        ...
        <div class="gallery-container position-relative">
            ...
            <div class="gallery-wrapper">
                <?php $__currentLoopData = $lingkungans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u972015595/domains/lavenderblush-cod-866989.hostingersite.com/public_html/laravel_app/resources/views/profil.blade.php ENDPATH**/ ?>